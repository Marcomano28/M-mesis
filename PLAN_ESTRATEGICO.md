...
| **Retorno al camerino** | ✅ código | La ficha interna se revisa sin perder identidad, transform ni guion del actor; hilos retirados silencian sus indicaciones |
...
- **Sesión de retoque**: mantiene la plaza escénica del actor por ID mientras una copia de su ficha vuelve al salón. Al regresar solo cambia cuerpo/materia/hilos/gestos; la puesta pertenece al Escenario.
